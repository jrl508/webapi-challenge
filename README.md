...
- [x] Mention two parts of Express that you learned about this week.
    ...
    Two parts of express that i used the most in its learning were routing and helper methods

- [x] Describe Middleware?
    
    Middleware is essentially an array of functions that execute in the order they are introduced. Usually used within another function they take 3 parameters, the first two deal with as their name suggests (Request, Response) and the last is next which is basically the green light to continue onto the next function.

- [x] Describe a Resource?

    A Resource is an object within a database, usually a client would be able to manipulate the object by reading, updating, or deleting, as well as creating a new object or resource.


- [x] What can the API return to help clients know if a request was successful?
    
    Status codes are helpful in communicating with the clients, 2xx usually refer to a successful requests, well written response messages are also a great tool for other devs to debug an issue and determine where the bugs are coming from

- [x] How can we partition our application into sub-applications?
    
    By using routing we can break or app down into several manageable components rather than producing a monolithic app which can be hard to navigate depending on the size
